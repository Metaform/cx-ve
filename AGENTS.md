...
- `OnboardingApi/` — Spring Boot 4.x application (Java 17, Gradle Kotlin DSL, package `com.metaform.cxve`). The Gradle root is the repo root; the app is the `:OnboardingApi` module.
...
./gradlew :OnboardingApi:test --tests "com.metaform.cxve.CxVeApplicationTests"   # single test class
