 ...
 * onboarding flow. All other components are optional — notably the BPN: when absent, the
 * BusinessPartnerNumberService assigns one at the BPN step of the onboarding.
 */
